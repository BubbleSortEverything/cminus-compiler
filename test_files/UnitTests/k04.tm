...
* COMPOUND
 40:    LDC  3,300(6)	Load of type int constant 
 41:    LDC  3,313(6)	Load of type int constant 
 42:    LDC  3,2(6)	Load of type int constant 
* COMPOUND
 43:     LD  3,-5(1)	Load variable i into accumulator 
 44:     ST  3,-6(1)	Assigning variable x in Local 
* CALL output
 45:     ST  1,-8(1)	Store fp in ghost frame for output 
 46:     LD  3,-6(1)	Load variable x into accumulator 
 47:     ST  3,-10(1)	Push parameter onto new frame 
* Begin call
 48:    LDA  1,-8(1)	Move the fp to the new frame 
...
* END CALL output
* CALL outnl
 52:     ST  1,-8(1)	Store fp in ghost frame for outnl 
* Begin call
 53:    LDA  1,-8(1)	Move the fp to the new frame 

...
* CALL output
 ...
 45:     ST  3,-5(1)	Push parameter onto new frame 
* Begin call
 46:    LDA  1,-3(1)	Move the fp to the new frame 
 47:    LDA  3,1(7)	Store the return address in ac (skip 1 ahead) 
 48:    JMP  7,-43(7)	Call function 
...
* END FUNCTION main
* 
  0:    JMP  7,58(7)	Jump to init [backpatch] 
* INIT

...
* END CALL cat
 56:     ST  3,-5(1)	Push left side onto temp variable stack 
* CALL cat
 57:     ST  1,-6(1)	Store fp in ghost frame for cat 
* Begin call
 58:    LDA  1,-6(1)	Move the fp to the new frame 
...
* CALL cat
 65:     ST  1,-6(1)	Store fp in ghost frame for cat 
* Begin call
 66:    LDA  1,-6(1)	Move the fp to the new frame 
...
* END CALL cat
 70:     LD  4,-5(1)	Pop left hand side into AC1 
 71:    MUL  3,4,3	* Multiplication Operation 
 72:     ST  3,-4(1)	Push parameter onto new frame 
* Begin call
...
* END CALL output
* CALL outnl
 77:     ST  1,-2(1)	Store fp in ghost frame for outnl 
* Begin call
 78:    LDA  1,-2(1)	Move the fp to the new frame 

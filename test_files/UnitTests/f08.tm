...
* CALL output
 ...
 51:    LDC  3,781(6)	Load of type int constant 
 52:     ST  3,-5(1)	Push left side onto temp variable stack 
* CALL cat
 53:     ST  1,-6(1)	Store fp in ghost frame for cat 
* Begin call
 54:    LDA  1,-6(1)	Move the fp to the new frame 
 55:    LDA  3,1(7)	Store the return address in ac (skip 1 ahead) 
 56:    JMP  7,-18(7)	Call function 
 57:    LDA  3,0(2)	Save return result in accumulator 
* END CALL cat
 58:     LD  4,-5(1)	Pop left hand side into AC1 
 59:    ADD  3,4,3	+ Operation 
 60:     ST  3,-4(1)	Push parameter onto new frame 
* Begin call
 61:    LDA  1,-2(1)	Move the fp to the new frame 
...
* Begin call
 66:    LDA  1,-2(1)	Move the fp to the new frame 

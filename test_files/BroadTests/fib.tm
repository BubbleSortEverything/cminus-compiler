...
* CALL output
 ...
 41:     LD  3,-2(1)	Load variable n into accumulator 
...
* CALL fib
 ...
 77:     LD  3,-2(1)	Load variable n into accumulator 
...
* CALL input
100:     ST  1,-8(1)	Store fp in ghost frame for input 
* Begin call
101:    LDA  1,-8(1)	Move the fp to the new frame 
102:    LDA  3,1(7)	Store the return address in ac (skip 1 ahead) 
103:    JMP  7,-103(7)	Call function 
104:    LDA  3,0(2)	Save return result in accumulator 
* END CALL input
105:     ST  3,-7(1)	Push parameter onto new frame 
* Begin call
106:    LDA  1,-5(1)	Move the fp to the new frame 
107:    LDA  3,1(7)	Store the return address in ac (skip 1 ahead) 
108:    JMP  7,-70(7)	Call function 

...
* CALL gcd
 ...
 95:     LD  3,-2(1)	Load variable x into accumulator 
 96:     ST  3,-7(1)	Push parameter onto new frame 
 97:     LD  3,-3(1)	Load variable y into accumulator 
...
101:    JMP  7,-63(7)	Call function 
102:    LDA  3,0(2)	Save return result in accumulator 
* END CALL gcd
103:     ST  3,-4(1)	Assigning variable z in Local 
* CALL output
104:     ST  1,-5(1)	Store fp in ghost frame for output 
105:     LD  3,-4(1)	Load variable z into accumulator 
106:     ST  3,-7(1)	Push parameter onto new frame 
* Begin call
...
* Begin call
112:    LDA  1,-5(1)	Move the fp to the new frame 

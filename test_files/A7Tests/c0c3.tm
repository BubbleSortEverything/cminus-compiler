...
* CALL outputc
 ...
 52:     LD  3,-1(0)	Load variable y into accumulator 
...
* CALL outputc
 ...
 60:     ST  3,0(0)	Assigning variable x in Global 
 61:     ST  3,-2(0)	Assigning variable z in Global 
...
* CALL outputc
 ...
 68:     LD  3,0(0)	Load variable x into accumulator 
 69:     ST  3,-4(1)	Push parameter onto new frame 
* Begin call
 70:    LDA  1,-2(1)	Move the fp to the new frame 
...
* CALL outputc
 ...
 75:     LD  3,-1(0)	Load variable y into accumulator 
...
* CALL outputc
 ...
 82:     LD  3,-2(0)	Load variable z into accumulator 
 83:     ST  3,-4(1)	Push parameter onto new frame 
* Begin call

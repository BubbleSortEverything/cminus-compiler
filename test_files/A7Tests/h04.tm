...
* CALL cat
107:     ST  1,-2(1)	Store fp in ghost frame for cat 
108:    LDA  3,-1(0)	Load base address of array x 
109:     ST  3,-4(1)	Push parameter onto new frame 
* Begin call
110:    LDA  1,-2(1)	Move the fp to the new frame 
111:    LDA  3,1(7)	Store the return address in ac (skip 1 ahead) 
112:    JMP  7,-74(7)	Call function 
...
* INIT
118:    LDA  1,-19(0)	set first frame at end of globals 
119:     ST  1,0(1)	store old fp (point to self) 
* INIT GLOBALS AND STATICS
120:    LDC  3,18(6)	Load size of x into AC 
121:     ST  3,0(0)	Store size of x in data memory 

...
* END IF
* BEGIN IF BLOCK
 53:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* BEGIN IF BLOCK
 68:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* END IF
* BEGIN IF BLOCK
 81:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* END IF
* BEGIN IF BLOCK
 96:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* END IF
* BEGIN IF BLOCK
113:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* END IF
* BEGIN IF BLOCK
130:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* END IF
* BEGIN IF BLOCK
150:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* BEGIN IF BLOCK
172:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* END IF
* BEGIN IF BLOCK
192:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* END IF
* BEGIN IF BLOCK
214:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK
...
* END IF
* BEGIN IF BLOCK
238:    LDC  3,0(6)	Load type bool constant 
* IF JUMP TO ELSE
* BEGIN IF BLOCK

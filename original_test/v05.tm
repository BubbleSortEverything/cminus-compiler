...
* COMPOUND
* TOFF set: -39
 83:    LDC  3,10(6)	load size of array a
 ...
 92:     ST  3,-13(1)	save size of array b
 12:    LIT  "bat"
 93:    LDA  3,-12(0)	Load address of char array 
 ...
 99:    LDC  3,6(6)	load size of array h
100:     ST  3,-18(1)	save size of array h
 17:    LIT  "horse"
101:    LDA  3,-17(0)	Load address of char array 
...
108:     ST  3,-25(1)	save size of array big
109:    LDC  3,2(6)	load size of array small
110:     ST  3,-36(1)	save size of array small
* Compound Body
* EXPRESSION
...
* EXPRESSION
* CALL outputs
117:     ST  1,-39(1)	Store fp in ghost frame for outputs
* TOFF dec: -40
* TOFF dec: -41
* Param 1
118:    LDA  3,-37(1)	Load address of base of array small
119:     ST  3,-41(1)	Push parameter 
* TOFF dec: -42
* Param end outputs
120:    LDA  1,-39(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL outnl
124:     ST  1,-39(1)	Store fp in ghost frame for outnl
* TOFF dec: -40
* TOFF dec: -41
* Param end outnl
...
* EXPRESSION
* CALL outputs
135:     ST  1,-39(1)	Store fp in ghost frame for outputs
* TOFF dec: -40
* TOFF dec: -41
* Param 1
136:    LDA  3,-26(1)	Load address of base of array big
137:     ST  3,-41(1)	Push parameter 
* TOFF dec: -42
* Param end outputs
138:    LDA  1,-39(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL outnl
142:     ST  1,-39(1)	Store fp in ghost frame for outnl
* TOFF dec: -40
* TOFF dec: -41
* Param end outnl
...
* EXPRESSION
* CALL outnl
147:     ST  1,-39(1)	Store fp in ghost frame for outnl
* TOFF dec: -40
* TOFF dec: -41
* Param end outnl
...
* TOFF set: -39
* EXPRESSION
152:    LDA  3,-14(1)	Load address of base of array b
...
* EXPRESSION
* CALL outputs
158:     ST  1,-39(1)	Store fp in ghost frame for outputs
* TOFF dec: -40
* TOFF dec: -41
* Param 1
159:    LDA  3,-37(1)	Load address of base of array small
160:     ST  3,-41(1)	Push parameter 
* TOFF dec: -42
* Param end outputs
161:    LDA  1,-39(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL outnl
165:     ST  1,-39(1)	Store fp in ghost frame for outnl
* TOFF dec: -40
* TOFF dec: -41
* Param end outnl
...
* TOFF set: -39
* EXPRESSION
170:    LDA  3,-14(1)	Load address of base of array b
...
* EXPRESSION
* CALL outputs
176:     ST  1,-39(1)	Store fp in ghost frame for outputs
* TOFF dec: -40
* TOFF dec: -41
* Param 1
177:    LDA  3,-26(1)	Load address of base of array big
178:     ST  3,-41(1)	Push parameter 
* TOFF dec: -42
* Param end outputs
179:    LDA  1,-39(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL outnl
183:     ST  1,-39(1)	Store fp in ghost frame for outnl
* TOFF dec: -40
* TOFF dec: -41
* Param end outnl
...
* EXPRESSION
* CALL outnl
188:     ST  1,-39(1)	Store fp in ghost frame for outnl
* TOFF dec: -40
* TOFF dec: -41
* Param end outnl
...
* TOFF set: -39
* EXPRESSION
193:    LDA  3,-19(1)	Load address of base of array h
...
* EXPRESSION
* CALL outputs
199:     ST  1,-39(1)	Store fp in ghost frame for outputs
* TOFF dec: -40
* TOFF dec: -41
* Param 1
200:    LDA  3,-37(1)	Load address of base of array small
201:     ST  3,-41(1)	Push parameter 
* TOFF dec: -42
* Param end outputs
202:    LDA  1,-39(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL outnl
206:     ST  1,-39(1)	Store fp in ghost frame for outnl
* TOFF dec: -40
* TOFF dec: -41
* Param end outnl
...
* TOFF set: -39
* EXPRESSION
211:    LDA  3,-19(1)	Load address of base of array h
...
* EXPRESSION
* CALL outputs
217:     ST  1,-39(1)	Store fp in ghost frame for outputs
* TOFF dec: -40
* TOFF dec: -41
* Param 1
218:    LDA  3,-26(1)	Load address of base of array big
219:     ST  3,-41(1)	Push parameter 
* TOFF dec: -42
* Param end outputs
220:    LDA  1,-39(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL outnl
224:     ST  1,-39(1)	Store fp in ghost frame for outnl
* TOFF dec: -40
* TOFF dec: -41
* Param end outnl
...
* EXPRESSION
* CALL outnl
229:     ST  1,-39(1)	Store fp in ghost frame for outnl
* TOFF dec: -40
* TOFF dec: -41
* Param end outnl
...
* INIT
238:    LDA  1,-23(0)	set first frame at end of globals 
